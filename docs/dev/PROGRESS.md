...
Atom 9: close-out — updated `.claude/skills/leann-search/SKILL.md`, `.claude/skills/leann-index/SKILL.md`, `docs/dev/DECISIONS-SEARCH.md`, `docs/UPGRADE.md`, and `docs/CHANGELOG.md` for Wave 1.5 multi-axis temporal behavior. Branch is ready to merge after the documented regression pass below.
